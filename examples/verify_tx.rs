...
use peercoin::consensus::Decodable;
use peercoin::secp256k1::{self, Secp256k1};
use peercoin::{absolute, sighash, Sequence};
...
fn main() {
    ...
    let _ = miniscript::Descriptor::<peercoin::PublicKey>::from_str(&desc_string)
    ...
    let prevouts = sighash::Prevouts::All::<peercoin::TxOut>(&[]);
    ...
    let iter = interpreter.iter_custom(Box::new(|key_sig: &KeySigPair| {
        ...
        ecdsa_sig.hash_ty == peercoin::sighash::EcdsaSighashType::All
            && secp
...
fn hard_coded_transaction() -> peercoin::Transaction {
    ...
    peercoin::Transaction::consensus_decode(&mut &tx_bytes[..]).expect("decode transaction")
}

fn hard_coded_script_pubkey() -> peercoin::ScriptBuf {
    peercoin::ScriptBuf::from(vec![
