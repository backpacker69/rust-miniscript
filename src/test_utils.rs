...
/// Translate from a String MiniscriptKey type to peercoin::PublicKey
...
pub struct StrKeyTranslator {
    pub pk_map: HashMap<String, peercoin::PublicKey>,
...
impl Translator<String, peercoin::PublicKey, ()> for StrKeyTranslator {
...
/// Same as [`StrKeyTranslator`], but for [`peercoin::XOnlyPublicKey`]
#[derive(Debug, PartialEq, Eq, Clone)]
...
impl StrKeyTranslator {
    pub fn new() -> Self {
        ...
        let pks: Vec<_> = sks
            .iter()
            .map(|sk| peercoin::PublicKey::new(secp256k1::PublicKey::from_secret_key(&secp, sk)))
            .collect();
